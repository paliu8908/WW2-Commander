...
export default function Units() {
    ...
    const UKData = data.filter(nation => nation.name === "UK")

    return (
        <section className="bg-[var(--darker-desert)] px-15 py-5 w-full">
            <h1 className="text-3xl font-bold mb-2 text-center text-black">The <span className="text-[var(--uk-blue)]">British</span> <span className="text-[var(--uk-red)]">Army</span></h1>
            <div>
                {UKData.map((stat, idx) => 
                    (
                      <div key={idx} className="">
                        <h1 className="py-2 text-xl font-bold text-[var(--uk-blue)] text-center my-2">ARMOUR <span className="text-[var(--uk-red)]">COMPANIES</span></h1>
                        ...
                        <h1 className="py-2 text-xl font-bold text-[var(--uk-blue)] text-center my-2">INFANTRY <span className="text-[var(--uk-red)]">COMPANIES</span></h1>
                        <ul className="grid grid-cols-3 gap-2 ">
