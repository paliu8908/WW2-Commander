...
export default function Units() {
    ...
    const GermanData = data.filter(nation => nation.name === "Italy")

    return (
        <section className="bg-[var(--darker-desert)] px-15 py-5 w-full">
            <h1 className="text-3xl font-bold mb-2 text-center text-black">The <span className="text-[var(--ita-green)]">Italian</span> <span className="text-[var(--ita-red)]">Army</span></h1>
            <div>
                {GermanData.map((stat, idx) => 
                    (
                      <div key={idx} className="">
                        <h1 className="py-2 text-xl font-bold text-[var(--ita-green)] text-center my-2">ARMOUR <span className="text-[var(--ita-red)]">COMPANIES</span></h1>
                        ...
                        <h1 className="py-2 text-xl font-bold text-[var(--ita-green)] text-center my-2">INFANTRY <span className="text-[var(--ita-red)]">COMPANIES</span></h1>
                        <ul className="grid grid-cols-3 gap-2 ">
